...
def fit_classifier_with_crossvalidation(
    X, y, basemod, cv, param_grid, scoring="r2", verbose=False
):
    ...
    for combination in crossvalidator.cv_results_:
        print(combination)
...
def fit_maxent_with_crossvalidation(X, y, C=1.0):
    ...
    * 'penalty': type of regularization -- roughly, 'l1' ecourages small
    ...
    return fit_classifier_with_crossvalidation(
        X, y, basemod, cv, param_grid, verbose=False
    )
