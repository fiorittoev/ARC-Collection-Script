...
def test_obama():
    ...
    return read_format(
        ["data/test/politicalrhetoric_complexitycoding.json_parsed.json"]
    )
...
def train_practice():
    ...
    return read_format(
        ["data/train/practice_sets1-10_final_second_full_test.json_parsed.json"]
    )
...
def train_heritability():
    ...
    return read_format(
        ["data/train/reaction_time_study_FINAL_second_full_test.json_parsed.json"]
    )
...
def punctuated_set():
    ...
    return read_format(
        [
            "sample_data/practice_sets1-10_final_punctuated.json_parsed.json",
...
def unpunctuated_set():
    ...
    return read_format(
        [
            "sample_data/practice_sets1-10_final_second_full_test.json_parsed.json",
