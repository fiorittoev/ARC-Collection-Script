...
english_parser = StanfordParser(
    os.path.join(path_to_stanford_nlp, "stanford-parser.jar"),
    os.path.join(path_to_stanford_nlp, "stanford-parser-4.2.0-models.jar"),
)
#internals.config_java(options="-Xmx512m")
...
def get_nouns_verbs(list_of_trees):
    ...
    ALLOWABLE = ["NN", "NNS", "NNP", "NNPS", "VB", "VBD", "VBG", "VBN", "VBP", "VBZ"]
    sentence_tokens = []
